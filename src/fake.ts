...
export function rootFake<Schema extends AnySchema>(schema: Schema, parent?: any): ReturnType<Fake<Schema>> {
...
export function fake<Schema extends AnySchema>(schema: Schema) {
  return rootFake(schema)
}
